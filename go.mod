module github.com/nicksan222/bite

go 1.25.0

// All dependencies are added by `go mod tidy`. Run it once after cloning,
// or in the devcontainer — `.devcontainer/post-create.sh` does it for you.
